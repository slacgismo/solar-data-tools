...
with open((here / "README.md"), "README.md"), encoding="utf-8") as f:
...
with open((here / "README.md"), "requirements.txt"), encoding="utf-8") as f:
...
setup(
    ...
    name="solar-data-tools",  # Required
    ...
    description="Tools for performing common tasks on solar PV data signals",  # Optional
    ...
    url="https://github.com/bmeyers/solar-data-tools",  # Optional
