...
class PVDAQPlug(DataPlug):
    ...
    """
    def __init__(self, year, api_key="DEMO_KEY", power_col="ac_power"):
        self.year = year
    ...
    def _pull_data(self, key):
        ...
        self.df = get_pvdaq_data(sysid=key, year=self.year, api_key=self.api_key)

    def _clean_data(self):
        # pick out one power col
        self.df = self.df[['ac_power']]

    def get_data(self, key: int) -> pd.DataFrame:
