...
class TestLinealizationHelper(unittest.TestCase):
    ...
    def test_obtain_component_r0(self):
        ...
        expected_result = np.array([1.36527916, 2.70624333, 4.04720749, 5.38817165])

        linearization_helper = LinearizationHelper(solver_type="ECOS")
        (
            left_low_rank_matrix_u,
            singular_values_sigma,
        ...
        actual_result = linearization_helper.obtain_component_r0(initial_r_cs_value)
