...
class TestIterativeFittingExecute(unittest.TestCase):
        ...
        for i in range(13):
            ...
            l_cs_value_left_matrix_file_path = os.path.abspath(
                os.path.join(
                    ...
                    "../fixtures/for_mock",
                    (
                        "l_cs_value_after_left_matrix_minimization_iteration_{}.csv".format(
                            i + 1
                        )
                    ),
                )
            ...
            r_cs_value_left_matrix_file_path = os.path.abspath(
                os.path.join(
                    ...
                    "../fixtures/for_mock",
                    (
                        "r_cs_value_after_left_matrix_minimization_iteration_{}.csv".format(
                            i + 1
                        )
                    ),
                )
            ...
            beta_value_left_matrix_file_path = os.path.abspath(
                os.path.join(
                    ...
                    "../fixtures/for_mock",
                    (
                        "beta_value_after_left_matrix_minimization_iteration_{}.csv".format(
                            i + 1
                        )
                    ),
                )
            ...
            left_matrix_minimize_return_values.append(
                (l_cs_value_left_matrix, r_cs_value_left_matrix, beta_value_left_matrix)
            )
        ...
        for i in range(13):
            ...
            l_cs_value_right_matrix_file_path = os.path.abspath(
                os.path.join(
                    ...
                    "../fixtures/for_mock",
                    (
                        "l_cs_value_after_right_matrix_minimization_iteration_{}.csv".format(
                            i + 1
                        )
                    ),
                )
            ...
            r_cs_value_right_matrix_file_path = os.path.abspath(
                os.path.join(
                    ...
                    "../fixtures/for_mock",
                    (
                        "r_cs_value_after_right_matrix_minimization_iteration_{}.csv".format(
                            i + 1
                        )
                    ),
                )
            ...
            beta_value_right_matrix_file_path = os.path.abspath(
                os.path.join(
                    ...
                    "../fixtures/for_mock",
                    (
                        "beta_value_after_right_matrix_minimization_iteration_{}.csv".format(
                            i + 1
                        )
                    ),
                )
    ...
    def test_execute(self):
        ...
        iterative_fitting.set_linearization_helper(self.mock_linearization_helper)
